...
/* const slide_right = document.querySelector('.offer__slider-next');
const slide_left = document.querySelector('.offer__slider-prev');
const total_img = document.querySelectorAll('.offer__slide');
let idx = 0;
