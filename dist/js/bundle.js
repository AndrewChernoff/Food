...
function cards() {
  ...
  (0,_DAL_dal__WEBPACK_IMPORTED_MODULE_1__.getMenuData)().then(function (data) {
...
/* harmony import */ var _DAL_dal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../DAL/dal */ "./js/DAL/dal.js");
...
function forms(modalSelector, formSelector) {
  ...
  function postFormData(form) {
    form.addEventListener('submit', function (e) {
      ...
      (0,_DAL_dal__WEBPACK_IMPORTED_MODULE_3__.sendFormData)('http://localhost:3000/requests', JSON.stringify(object)).then(function (data) {
        console.log(data);
        form.reset();
        setTimeout(function () {
          ...
          setTimeout(function () {
            (0,_modal__WEBPACK_IMPORTED_MODULE_2__.closemodalWindow)(modalSelector);
          }, 2000);
        }, 2000);
      })["catch"](function (data) {
        console.log('damn');
