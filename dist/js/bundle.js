...
var sendFormData = /*#__PURE__*/function () {
  ...
  return function sendFormData(_x, _x2) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw newError("Could not fetch ".concat(url, ", status: ").concat(request.status));
...
function calc() {
  ...
  function getParams(attribute, activeClassName) {
    var element = document.querySelectorAll("".concat(attribute, " div"));
  ...
  function getBodyParams(attribute) {
    var input = document.querySelector(attribute);
...
/* harmony import */ var _DAL_dal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../DAL/dal */ "./js/DAL/dal.js");
...
function cards() {
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(img, title, descr, price, elementSelector) {
  ...
  (0,_DAL_dal__WEBPACK_IMPORTED_MODULE_5__.getMenuData)().then(function (data) {
...
/* harmony import */ var _DAL_dal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./../DAL/dal */ "./js/DAL/dal.js");
...
function forms(modalSelector, formSelector) {
  ...
  function postFormData(form) {
    form.addEventListener('submit', function (e) {
      ...
      (0,_DAL_dal__WEBPACK_IMPORTED_MODULE_7__.sendFormData)('http://localhost:3000/requests', JSON.stringify(object)).then(function (data) {
        console.log(data);
        form.reset();
        setTimeout(function () {
          ...
          setTimeout(function () {
            (0,_modal__WEBPACK_IMPORTED_MODULE_6__.closemodalWindow)(modalSelector);
          }, 2000);
        }, 2000);
      })["catch"](function (data) {
        console.log('damn');
...
function openModal(modalSelector, openModalInTime) {
  ...
  document.querySelector('body').style.overflow = 'hidden'; //console.log(modal);
...
function slider(_ref) {
  var rigthArrow = _ref.rigthArrow,
      leftArrow = _ref.leftArrow,
      offerSlide = _ref.offerSlide,
      images = _ref.images,
      wrapper = _ref.wrapper,
      slider_Inner = _ref.slider_Inner;
  ////slider
  var nextBtn = document.querySelector(rigthArrow);
  var prevBtn = document.querySelector(leftArrow);
  var slides = document.querySelectorAll(offerSlide);
  var slidesImg = document.querySelectorAll(images);
  var slidesWrapper = document.querySelector(wrapper);
  var sliderInner = document.querySelector(slider_Inner);
  var width = window.getComputedStyle(sliderInner).width;
  var offset = 0;
  var idx = 1;
  ...
  slidesImg.forEach(function (slide) {
...
window.addEventListener('DOMContentLoaded', function () {
  var openModalInTime = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal)('.modal', openModalInTime);
  }, 3000);
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.tabheader__items', '.tabcontent', '.tabheader__item', '.tabheader__item_active');
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__["default"])('.modal', '[data-modal]', openModalInTime);
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_modules_time__WEBPACK_IMPORTED_MODULE_5__["default"])('.time', '2022-03-03');
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_6__["default"])('.modal', 'form');
